...
export const Icons = {
  ...
  ScanFace: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9 2h6" /><path d="M19 2h1a2 2 0 0 1 2 2v1" /><path d="M2 5V4a2 2 0 0 1 2-2h1" /><path d="M2 19v1a2 2 0 0 0 2 2h1" /><path d="M19 22h1a2 2 0 0 0 2-2v-1" /><path d="M9 22h6" /><path d="M9 8h.01" /><path d="M15 8h.01" /><path d="M12 16c-1 0-2-.6-2-1.4 0-.8.6-1.6 2-1.6s2 .8 2 1.6c0 .8-1 1.4-2 1.4Z" /></svg>
  ),
  Camera: (props: any) => (
